...
In order to support loading of multiple wallets in mobinode-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mobinode.cpp.
...
Changes to mobinode.cpp
----------------------
mobinode.cpp is the entry point into mobinode-qt, and as such, will require some minor modifications to provide hooks for
