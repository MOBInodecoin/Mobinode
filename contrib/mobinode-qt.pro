...
RESOURCES += src/qt/mobinode.qrc src/qt/mobinode_locale.qrc

TRANSLATIONS += src/qt/locale/mobinode_bg.ts \
                src/qt/locale/mobinode_de.ts \
                src/qt/locale/mobinode_en.ts \
                src/qt/locale/mobinode_es.ts \
                src/qt/locale/mobinode_fi.ts \
                src/qt/locale/mobinode_fr.ts \
                src/qt/locale/mobinode_it.ts \
                src/qt/locale/mobinode_ja.ts \
                src/qt/locale/mobinode_pl.ts \
                src/qt/locale/mobinode_pt.ts \
                src/qt/locale/mobinode_ru.ts \
                src/qt/locale/mobinode_sk.ts \
                src/qt/locale/mobinode_sv.ts \
                src/qt/locale/mobinode_vi.ts \
                src/qt/locale/mobinode_zh_CN.ts \
                src/qt/locale/mobinode_zh_TW.ts
