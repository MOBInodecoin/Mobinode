Contributing to Mobinode
============================

The Mobinode project operates an open contributor model where anyone is
...
The following applies to code changes to the Mobinode project, and is not to be
confused with overall Mobinode Network Protocol consensus changes.

Whether a pull request is merged into Mobinode rests with the project merge
...
Patches that change Mobinode consensus rules are considerably more involved than
...
Where a patch set proposes to change the Mobinode consensus, it must have been
...
The project leader is the release manager for each Mobinode release.
