...
#   c) node1 mines 32 blocks, so now node 0 has 60001mobi, node 1 has 4250mobi, node2 has none.
#   d) node0 sends 601 mobi to node2, in two transactions (301 mobi, then 300 mobi).
