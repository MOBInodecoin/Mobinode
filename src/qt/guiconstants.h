...
/* Mobinode GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Mobinode"
#define QAPP_ORG_DOMAIN "mobinode.org"
#define QAPP_APP_NAME_DEFAULT "Mobinode-Qt"
#define QAPP_APP_NAME_TESTNET "Mobinode-Qt-testnet"
