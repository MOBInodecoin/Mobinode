...
/** Utility functions used by the Mobinode Qt UI.
 */
namespace GUIUtil
{
...
// Render Mobinode addresses in monospace font
...
// Parse "mobinode:" URI into recipient object, return true on successful parsing
