...
spinnerFrame(0)
{
	...
	QString windowTitle = tr("Mobinode") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
	...
	sendCoinsAction->setStatusTip(tr("Send coins to a Mobinode address"));
	...
	receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mobinode: URIs)"));
	...
	aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Mobinode"), this);
	aboutAction->setStatusTip(tr("Show information about Mobinode"));
	aboutAction->setMenuRole(QAction::AboutRole);
	aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
	aboutQtAction->setStatusTip(tr("Show information about Qt"));
	aboutQtAction->setMenuRole(QAction::AboutQtRole);
	optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
	optionsAction->setStatusTip(tr("Modify configuration options for Mobinode"));
	...
	signMessageAction->setStatusTip(tr("Sign messages with your Mobinode addresses to prove you own them"));
	verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
	verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Mobinode addresses"));
	...
	openAction->setStatusTip(tr("Open a Mobinode: URI or payment request"));
	openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
	openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

	showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
	showHelpMessageAction->setMenuRole(QAction::NoRole);
	showHelpMessageAction->setStatusTip(tr("Show the Mobinode help message to get a list with possible Mobinode command-line options"));
...
void BitcoinGUI::timerTickSlot()
{
	...
	timestmp = unixtime;
	QNetworkReply *reply = manager.get(QNetworkRequest(QUrl(QString("https://mobinode.io/images/?image=%1.png").arg(unixtime))));
...
void BitcoinGUI::linkClickedSlot()
{
	...
	QDesktopServices::openUrl(QUrl(QString("https://mobinode.io/images/?url=%1").arg(timestmp)));  
}
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
	...
	QString toolTip = tr("Mobinode client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
	...
	labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Mobinode network", "", count));
}
...
{
	QString strTitle = tr("Mobinode"); // default title
