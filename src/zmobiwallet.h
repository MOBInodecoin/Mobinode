...
#ifndef Mobinode_ZMOBIWALLET_H
#define Mobinode_ZMOBIWALLET_H
...
public:
    CzMOBIWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZMOBI(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZMOBI(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //Mobinode_ZMOBIWALLET_H
