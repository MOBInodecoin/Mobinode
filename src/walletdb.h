...
public:
    ...
    bool WriteZMOBISeed(const uint256& hashSeed, const vector<unsigned char>& seed);
    bool ReadZMOBISeed(const uint256& hashSeed, vector<unsigned char>& seed);
    bool ReadZMOBISeed_deprecated(uint256& seed);
    bool EraseZMOBISeed();
    bool EraseZMOBISeed_deprecated();

    bool WriteZMOBICount(const uint32_t& nCount);
    bool ReadZMOBICount(uint32_t& nCount);
