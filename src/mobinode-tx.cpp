...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Mobinode mobinode-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  mobinode-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mobinode transaction") + "\n" +
                               "  mobinode-tx [options] -create [commands]   " + _("Create hex-encoded mobinode transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mobinode transaction
