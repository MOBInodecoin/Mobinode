...
// Copyright (c) 2016-2018 The Mobinode developers
...
// Mobinode: on startup load spork values from previous session if they exist in the sporkDB
...
void ProcessSpork(CNode* pfrom, std::string& strCommand, CDataStream& vRecv)
{
    ...
    if (strCommand == "spork") {
        ...
        // Mobinode: add to spork database.
...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_17_DISABLE_STAKE_MINIMAL) r = SPORK_17_DISABLE_STAKE_MINIMAL_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_17_DISABLE_STAKE_MINIMAL") return SPORK_17_DISABLE_STAKE_MINIMAL;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_17_DISABLE_STAKE_MINIMAL) return "SPORK_17_DISABLE_STAKE_MINIMAL";
